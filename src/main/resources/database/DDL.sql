...
CREATE TABLE medicine(
    ...
    CONSTRAINT fk_idmodeadm FOREIGN KEY (codemodeadmin) REFERENCES modeadministration(id),
...
CREATE TABLE farmacymedicine(
    ...
    idmedicinefatrm INT,
    price FLOAT(8),
    CONSTRAINT pk_idfarmacymedicine PRIMARY KEY (idfarmacy,idmedicimefatrm),
